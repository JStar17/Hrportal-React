        ...
        <li class="nav-item">
          ...
          <div class="collapse" id="Example">
            <ul class="nav flex-column sub-menu">
              <li class="nav-item">
                {" "}
                <Link class="nav-link" to="empsalary">
                  Employee Salary
                </Link>
              </li>
            </ul>
        ...
        <li class="nav-item">
          ...
          <div class="collapse" id="tables">
            <ul class="nav flex-column sub-menu">
              <li class="nav-item">
                {" "}
                <Link class="nav-link" to="celebrationdetail">
              ...
              {localStorage.getItem("role") == "HR " ? (
                <li class="nav-item">
                  {" "}
                  <Link class="nav-link" to="addcelebration">
                    Add Celebrations
                  </Link>
                </li>
              ) : (
          ...
          <div class="collapse" id="charts">
            <ul class="nav flex-column sub-menu">
              {localStorage.getItem("role") == "HR " ? (
                <li class="nav-item">
                  {" "}
                  <Link class="nav-link" to="leavedetails">
                    Leave Applications
                  </Link>
                </li>
              ) : (
              ...
              <li class="nav-item">
                {" "}
                <Link class="nav-link" to="addleave">
                  Apply for Leave
                </Link>
              </li>
              <li class="nav-item">
                {" "}
                <Link class="nav-link" to="leavestatus">
                  Leave Status
                </Link>
              </li>
            </ul>
